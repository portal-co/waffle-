...
// These imports create circular dependencies - methods using them should be in their respective crates
// use crate::backend::WasmFuncBackend;
use crate::cfg::CFGInfo;
use crate::{EntityRef, EntityVec, PerEntity};
...
impl<'a> FuncDecl<'a> {
    ...
    ///
    // NOTE: convert_to_max_ssa moved to passes crate to avoid circular dependencies
...
impl FunctionBody {
    ...
    // NOTE: optimize() and convert_to_max_ssa() methods moved to passes crate
    // to avoid circular dependencies in the workspace
